...
import { Settings, User, Lock, Bell, Shield, CheckCircle2 } from "lucide-react";
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 max-w-4xl mx-auto">
        ...
        <GlassCard glowColor="cyan" className="p-8 border-white/10">
          <form onSubmit={handleSave} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white/[0.04] border border-white/15 rounded-xl px-4 py-2 text-xs text-white focus:outline-none focus:border-cyan-400"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="password"
                    placeholder="••••••••••••"
                    className="w-full bg-white/[0.04] border border-white/15 rounded-xl px-4 py-2 text-xs text-white focus:outline-none focus:border-purple-400"
                  />
                </div>
            ...
            <div className="pt-4 flex justify-end">
              <button
                type="submit"
                className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold text-xs shadow-glow-cyan hover:shadow-glow-blue transition"
              >
                Save Preferences
              </button>
            </div>
